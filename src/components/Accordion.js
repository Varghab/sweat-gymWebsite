...
const Accordion = ({question, active, index, setActive, answer}) => {
    ...
    return (
        <div className={`w-96 rounded-xl transition-all duration-300 ease-in-out border-2 border-neutral-500/30 overflow-hidden items-center p-4 bg-neutral-950 flex flex-col ${index===active?'gap-6':'gap-0'}`}>
