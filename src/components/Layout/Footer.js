        ...
        <div className='mx-auto w-11/12 flex flex-col lg:flex-row md:flex-row text-white justify-around text-center md:text-left lg:text-left'>
            ...
            <div className=''>
                <ul className='flex flex-col gap-2 cursor-pointer'>
                    ...
                    <li className='transition-text duration-150 ease-in-out text-neutral-300/90 hover:text-orange-500'>Features</li>
            ...
            <div className='mt-6 lg:mt-0 md:mt-0'>
                <ul className='flex flex-col gap-2 cursor-pointer'>
                    ...
                    <li className='transition-text duration-150 ease-in-out text-neutral-300/90 hover:text-orange-500'>Blogs</li>
