        ...
        <div className='w-11/12 mx-auto flex flex-col lg:flex-row md:flex-row justify-around items-center text-white p-6 gap-14 lg:gap-0'>
            ...
            <div className='rounded-xl w-80 bg-neutral-900 p-6 order-1 lg:order-2'>
                <div>
                    ...
                    <form ref={formRef} onSubmit={submitHandler} className='mt-8 flex flex-col gap-4'>
                        <input name='name' className='rounded-md bg-neutral-700 px-2 py-2 w-full border-none outline-none placeholder:text-white text-white' placeholder='Name'></input>
                        <input name='email' className='rounded-md bg-neutral-700 px-2 py-2 w-full border-none outline-none placeholder:text-white text-white' placeholder='Email'></input>
                        <textarea name='message' rows='4' className='rounded-md bg-neutral-700 px-2 py-2 border-none resize-none placeholder:text-white text-white scroll outline-none' placeholder='Enter your message here...'></textarea>
